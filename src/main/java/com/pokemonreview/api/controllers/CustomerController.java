...
@Tag(name = "Customar controller Rest api all Customar")
...
public class CustomerController {
    ...
    //@Operation(description = "customer controller REST API to add")
    @PostMapping("/add")
    ...
    //@Operation(description = "customer controller REST API to edit customer")
...
*/
    //@Operation(description = "customer controller REST API to delete customer")
    ...
    //@Operation(description = "customer controller REST API to get all customer")
    @GetMapping(path = "/get")
    ...
    //@Operation(description = "customer controller REST API to get customer by id")
