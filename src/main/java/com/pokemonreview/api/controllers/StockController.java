...
//@Api(value = "stock controller Rest api all stock")
@RequestMapping( "/api/v1/stock")
@RestController
public class StockController {
    @Autowired
    private StockDao stockDao;
    //@ApiOperation(value = "stock controller REST API to add")
   ...
   //@ApiOperation(value = "Stock controller REST API to edit stock")
    ...
    //@ApiOperation(value = "stock controller REST API to delete stock")
   ...
   // @ApiOperation(value = "stock controller REST API to get all stock")
    @GetMapping(path = "/get")
    public ResponseEntity<List<Stockdto>> getAllStocks(){
        return ResponseEntity.ok().body(stockDao.getAllStock());
    }
    //public List<Stock> getSales() {return this.stockDao.getstock();}
    //@ApiOperation(value = "stock controller REST API to get stock by id")
