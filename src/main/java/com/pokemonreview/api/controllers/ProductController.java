...
//@Tag(name = "product controller Rest api all product")
@RequestMapping("/api/v1/product")
@RestController
public class ProductController {
    @Autowired
    private ProductDao productDao;
   //@Operation(description = "product controller REST API to add")
    @PostMapping("/add")
    ...
    //@Operation(description = "product controller REST API to edit product")
   ...
   //@Operation(description = "product controller REST API to delete product")
    ...
    //@Operation(description = "product controller REST API to get all product")
    @GetMapping("get")
    public ResponseEntity<List<Productdto>> getAll(){
        return ResponseEntity.ok().body(productDao.get());
    }
    //@Operation(description = "product controller REST API to get product by id")
